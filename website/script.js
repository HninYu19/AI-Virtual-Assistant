...
Debugger.log =
  ...
  try {
      ...
      function onTimer() {
        ...
        if (count >= wait) {
          ...
          for (i = 0; i < numToAddEachFrame; i++) {
            ...
            var p = addParticle(
                x0, sphereCenterY + y0, sphereCenterZ + z0, 0.002 * x0,
                0.002 * y0, 0.002 * z0);
        ...
        while (p != null) {
          ...
          rotZ = -sinAngle * p.x + cosAngle * (p.z - sphereCenterZ) +
              sphereCenterZ;
          ...
          if (outsideTest || p.dead) {
            ...
            context.beginPath();
            context.arc(
                p.projX, p.projY, m * particleRad, 0, 2 * Math.PI, false);
            context.closePath();
            context.fill();
          }
          p = nextParticle;
    ...
    // Message display functions for EEL
    $(document)
        .ready(function() {
          // Show Spoken Message
